...
def api_pdf_ocr(pdf_file, output_directory):
    ocrmypdf.ocr(f'{pdf_file}', f'{output_directory}/{pdf_file}', deskew=True, force_ocr=True, invalidate_digital_signatures=True)